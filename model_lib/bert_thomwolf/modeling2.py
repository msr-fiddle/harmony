""" NOTE: 
    ...
    2) Add a flag to skip data preprocessing
"""
# coding=utf-8
...
} # each contains: 'bert_config.json' and 'pytorch_model.bin'
...
class BertModel(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=True, bypass_proc=True): 
        if not bypass_proc:
