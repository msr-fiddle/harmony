...
class vLayer82(torch.nn.Module):
    def __init__(self):
        super(vLayer82, self).__init__()
        self.layer1 = ConvLayer(in_channels=64, out_channels=128, batch_norm=False, inplace=True, max_pool=False)
