...
class vLayer246(torch.nn.Module):
    def __init__(self):
        super(vLayer246, self).__init__()
        self.layer1 = ConvLayer(in_channels=256, out_channels=256, batch_norm=False, inplace=True, max_pool=True)
