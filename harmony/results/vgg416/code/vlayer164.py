...
class vLayer164(torch.nn.Module):
    def __init__(self):
        super(vLayer164, self).__init__()
        self.layer1 = ConvLayer(in_channels=128, out_channels=256, batch_norm=False, inplace=True, max_pool=False)
