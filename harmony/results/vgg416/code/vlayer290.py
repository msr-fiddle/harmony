...
class vLayer290(torch.nn.Module):
    def __init__(self):
        super(vLayer290, self).__init__()
        self.layer1 = ConvLayer(in_channels=512, out_channels=512, batch_norm=False, inplace=True, max_pool=False)
