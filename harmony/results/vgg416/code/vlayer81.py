...
class vLayer81(torch.nn.Module):
    def __init__(self):
        super(vLayer81, self).__init__()
        self.layer1 = ConvLayer(in_channels=64, out_channels=64, batch_norm=False, inplace=True, max_pool=True)
