...
class vLayer163(torch.nn.Module):
    def __init__(self):
        super(vLayer163, self).__init__()
        self.layer1 = ConvLayer(in_channels=128, out_channels=128, batch_norm=False, inplace=True, max_pool=True)
